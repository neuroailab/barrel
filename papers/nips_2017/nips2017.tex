...
\newcommand{\DefaultFigSize}{1}
\newcommand{\ArchiFigSize}{.9}
\newcommand{\SchFigSize}{.85}

\newcommand{\FigCenter}{\centering}
%\newcommand{\WEBSITE}{[WITHHELD]}
\newcommand{\WEBSITE}{\url{https://github.com/neuroailab/whisker_model}}
...
\vspace{-3mm}
\section{Acknowledgement}  %~250 words
\vspace{-4mm}
