...
#file_name = os.path.join('/home/chengxuz/barrel/related_files/hdf5_files', 'chair_-3556003778771439030_0_0_0_0.hdf5')
#file_name = os.path.join('/Users/chengxuz/barrel/bullet/barrle_related_files/hdf5s', 'chair_-54611823245303397_1_3_0_2.hdf5')
#file_name = os.path.join('/Users/chengxuz/barrel/bullet/barrle_related_files/hdf5s', 'Data0_0_.hdf5')
file_name = os.path.join('/Users/chengxuz/barrel/bullet/barrle_related_files/hdf5s', 'Data10000_0_ad0b349657fb807d88d19ffcab9e20eb.hdf5')
...
for now_im_indx in xrange(5):
    ...
    #save_im_name = 'chair_large_%s.png' % now_im_indx
    save_im_name = 'monitor_%s.png' % now_im_indx
    #save_im_name = 'teddy_%s.png' % now_im_indx
    #normal = np.asarray(fin['Data_normal'][now_im_indx])
    normal = np.asarray(fin['Data0/Data_normal'][now_im_indx])

    #result = Image.fromarray((normal * 255).astype(np.uint8))
    result = Image.fromarray(normal)
