...
def main():
    ...
    parser.add_argument('--saveprefix', default = '/scratch/users/chengxuz/barrel/barrel_relat_files/dataset/statistic/Data_torque_', type = str, action = 'store', help = 'Name prefix for the saved pkl')
