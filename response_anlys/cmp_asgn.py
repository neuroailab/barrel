...
def get_file_list():
    ...
    subfolder_list = ['spatemp_sm2_RDMs_obj', 'spa_temp_RDMs_obj',
            'temp_spa_RDMs_s0_obj', 'temp_spa_RDMs_s1_obj',
            'temp_spa_RDMs_s2_obj', 'temp_spa_RDMs_s3_obj', 'temp_spa_RDMs_s4_obj', 
            'fdb_RDMs_s0_obj', 'fdb_RDMs_s1_obj', 'fdb_RDMs_s2_obj', 'fdb_RDMs_s3_obj', 'fdb_RDMs_s4_obj'
           ]
    ...
    file_list = filter(lambda x: 'concat' not in x, file_list)
    file_list = filter(lambda x: 'fc_add' not in x, file_list)
    print(len(file_list))
